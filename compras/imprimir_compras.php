	...
	<body>
		...
		<div class="container ">
			...
			<div class="row">
				...
				<h4 class="text-center"><strong>ORDEN DE COMPRA</strong>
					
					<button class="btn btn-info hidden-print" onclick="window.print();">
						...
						<table id="tabla_venta" class="table table-hover table-bordered table-condensed">
							...
							<tbody>
								...
								<?php foreach ($filas as $i => $producto) { ?>
									...
									<tr>
										<th class="text-center"><?php echo number_format($producto["cantidad"]);?></th>
